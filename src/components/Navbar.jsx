...
const [nav,setNav] =useState(false)
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Delish <span className='font-bold'>Trek</span> </h1>
      <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
        ...
        <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
            ...
            <input className='bg-transparent p-2 w-fullfocus:outline-none' type='text' placeholder='Search Foods' />
        </div>
        ...
        {/* Cart button*/}
         ...
         {nav ? <div className='bg-black/80 fixed w-full h-screen z-10 top-0 left-0'></div> : ''}
           ...
           <h2 className='text-2xl p-4'>Delish <span className='font-bold'>Trek</span></h2>
           <nav>
